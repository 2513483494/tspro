...
const ProductTable = (props: any) => {
  ...
  const handleOk = () => {
    ...
    if (selectedProducts.length) {
      ...
      newData = [
        ...dataSource.slice(0, onChangedProductIndex),
        dataSource[onChangedProductIndex],
        ...dataSource.slice(onChangedProductIndex + 1),
      ];
    }
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (v: any, record: any, index: any) => (
        <>
          <span>{v}</span>
          <Button type="link" onClick={() => changeProductPrice(v, index)}>
            改价
          </Button>
        </>
      ),
    ...
    },
    {
      ...
      render: (v: any, record: any, index: any) => (
        <>
          <Button type="link" onClick={() => changeInfo(record, index)}>
            修改
          </Button>
          <Button type="link" onClick={() => delTheProduct(index)}>
            删除
          </Button>
        </>
      ),
